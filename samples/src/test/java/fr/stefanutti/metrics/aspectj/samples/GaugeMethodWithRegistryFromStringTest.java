...
public class GaugeMethodWithRegistryFromStringTest {
    ...
    @Test
    public void gaugeMethodCalledOnNewObject() {
        ...
        assertThat(gauge.getValue(), is(equalTo(Integer.valueOf(0))));
    }

    @Test
    public void callGaugeMethodAfterSetterCall() {
        assertThat(SharedMetricRegistries.names(), hasItem(REGISTRY_NAME));
        MetricRegistry registry = SharedMetricRegistries.getOrCreate(REGISTRY_NAME);
        assertThat(registry.getGauges(), hasKey(GAUGE_NAME));
        Gauge<Integer> gauge = registry.getGauges().get(GAUGE_NAME);
        ...
        instance.setGauge(1);
        assertThat(gauge.getValue(), is(equalTo(Integer.valueOf(1))));
    }
}
